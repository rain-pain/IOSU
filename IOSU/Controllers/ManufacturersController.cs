...
namespace IOSU.Controllers
{
    public class ManufacturersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Certification,CreationData")] Manufacturer manufacturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Certification,CreationData")] Manufacturer manufacturer)
        {
